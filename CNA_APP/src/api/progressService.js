...
const progressService = {
  ...
  getAllFeedback: async (page = 1, limit = 50, filters = {}) => {
    try {
      ...
      const response = await axios.get(`${API_BASE_URL}/progress/feedback/all?${params}`, {
        withCredentials: true
      });
      return response.data;
    } catch (error) {
  ...
  updateChatSimProgress: async (skillId, sessionId, rating, duration, feedback = '') => {
    try {
