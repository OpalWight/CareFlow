        ...
        <div className="login-container">
            ...
            {successMessage && (
                <div className="login-success-message">
                    <strong id="login-success-strong">Success!</strong> {successMessage}
                    <button 
            ...
            {error && (
                <div className="login-error-message">
                    <strong id="login-error-strong">Error:</strong> {error}
                    <button 
                        onClick={clearError}
            ...
            <div className="login-divider">
                ...
                >
                    {(loading || authLoading) ? 'Redirecting...' : (
                        <>
                            <svg id="login-google-svg" width="18" height="18" viewBox="0 0 24 24">
